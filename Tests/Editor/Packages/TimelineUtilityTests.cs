...
namespace UnityExtensions.Tests.Editor
{
    public class TimelineUtilityTests
    {
        //https://github.com/Unity-Technologies/UnityLiveCapture/blob/4.0.1/Packages/com.unity.live-capture.tests/Tests/Editor/Core/TimelineUtilityTests.cs
