...
{
    public class Test_Span2D
    {
        //https://github.com/CommunityToolkit/dotnet/blob/657c6971a8d42655c648336b781639ed96c2c49f/tests/CommunityToolkit.HighPerformance.UnitTests/Memory/Test_Span2D%7BT%7D.cs
        #region CommunityToolkit.HighPerformance.UnitTests
        [Test]
        public void Test_Span2DT_Empty()
        {
            ...
            Assert.AreEqual(empty1.Length, (nint)0);
            ...
            Assert.AreEqual(empty2.Length, (nint)0);
        ...
        public unsafe void Test_Span2DT_PtrConstructor()
        {
            ...
            Assert.AreEqual(span2d.Length, (nint)6);
        ...
        public void Test_Span2DT_Array1DConstructor()
        {
            ...
            Assert.IsFalse(span2d.IsEmpty);
            Assert.AreEqual(span2d.Length, (nint)4);
            ...
            _ = Assert.Throws<ArrayTypeMismatchException>(() => new Span2D<object>(new string[1], 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, -99, 1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 0, -10, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 0, 1, 1, -1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 0, 1, -100, 1));
            _ = Assert.Throws<ArgumentException>(() => new Span2D<int>(array, 0, 10, 1, 120));
        }
        ...
        public void Test_Span2DT_Array2DConstructor_1()
        {
            ...
            _ = Assert.Throws<ArrayTypeMismatchException>(() => new Span2D<object>(new string[1, 2]));
        }
        ...
        public void Test_Span2DT_Array2DConstructor_2()
        {
            ...
            _ = Assert.Throws<ArrayTypeMismatchException>(() => new Span2D<object>(new string[1, 2], 0, 0, 2, 2));
        }
        ...
        public void Test_Span2DT_Array3DConstructor_1()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, -1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 20));
        }
        ...
        public void Test_Span2DT_Array3DConstructor_2()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, -1, 1, 1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 1, -1, 1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 1, 1, -1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 1, 1, 1, -1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 1, 1, 1, 1, -1));
        ...
        public void Test_Span2DT_CopyTo_1()
        {
            ...
            _ = Assert.Throws<ArgumentException>(() => new Span2D<int>(array).CopyTo(Span<int>.Empty));
        }
        ...
        public void Test_Span2DT_CopyTo_2()
        {
            ...
            _ = Assert.Throws<ArgumentException>(() => new Span2D<int>(array).CopyTo(Span<int>.Empty));
            _ = Assert.Throws<ArgumentException>(() => new Span2D<int>(array, 0, 1, 2, 2).CopyTo(Span<int>.Empty));
        }
        ...
        public void Test_Span2DT_CopyTo2D_1()
        {
            ...
            _ = Assert.Throws<ArgumentException>(() => new Span2D<int>(array).CopyTo(Span2D<int>.Empty));
        }
        ...
        public void Test_Span2DT_CopyTo2D_2()
        {
            ...
            _ = Assert.Throws<ArgumentException>(() => new Span2D<int>(array).CopyTo(new Span2D<int>(target)));
        }
        ...
        public void Test_Span2DT_Slice_1()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(-1, 1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(1, -1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(1, 1, 1, -1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(1, 1, -1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(10, 1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(1, 12, 1, 12));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).Slice(1, 1, 55, 1));
        }
        ...
        public void Test_Span2DT_TryGetSpan_From1DArray_1()
        {
            ...
            Assert.AreEqual(span.Length, (int)span2d.Length);
            Assert.AreEqual(array[0], span[0]);
        }
        ...
        public void Test_Span2DT_TryGetSpan_From1DArray_2()
        {
            ...
            Assert.IsTrue(success);
            Assert.AreEqual(span.Length, (int)span2d.Length);
            Assert.AreEqual(array[3], span[0]);
        }
        ...
        public void Test_Span2DT_GetRow()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).GetRow(-1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).GetRow(2));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).GetRow(1000));
        }
#endif // ZERO
        ...
        public unsafe void Test_Span2DT_Pointer_GetRow()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 2, 3, 0).GetRow(-1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 2, 3, 0).GetRow(2));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 2, 3, 0).GetRow(1000));
        }
        ...
        public void Test_Span2DT_GetColumn()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).GetColumn(-1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).GetColumn(3));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array).GetColumn(1000));
        }
#endif // ZERO
        ...
        public unsafe void Test_Span2DT_Pointer_GetColumn()
        {
            ...
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 2, 3, 0).GetColumn(-1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 2, 3, 0).GetColumn(3));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => new Span2D<int>(array, 2, 3, 0).GetColumn(1000));
        }
        ...
        #endregion // CommunityToolkit.HighPerformance.UnitTests

        [Test]
        public void Test_Span2DT_NativeArray1DConstructor()
        {
            var array = new Unity.Collections.NativeArray<int>(6,
            ...
            // Same as above, but wrapping a 1D array with data in row-major order
            Span2D<int> span2d = array.AsSpan2D(1, 2, 2, 1);
            ...
            // The others just validate a number of cases with invalid arguments (eg. out of range).
            _ = Assert.Throws<ArrayTypeMismatchException>(() => new Span2D<object>(new string[1], 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(-99, 1, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(0, -10, 1, 1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(0, 1, 1, -1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(0, 1, -100, 1));
            //_ = Assert.Throws<ArgumentException>(() => array.AsSpan2D(0, 10, 1, 120));
        }

        [Test]
        public void Test_Span2DT_TryGetSpan_From1DNativeArray_1()
        {
            var array = new Unity.Collections.NativeArray<int>(9,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory)
            {
                [0] = 1,
                [1] = 2,
            ...
            Span2D<int> span2d = array.AsSpan2D(3, 3);
        ...
        [Test]
        public void Test_Span2DT_TryGetSpan_From1DNativeArray_2()
        {
            var array = new Unity.Collections.NativeArray<int>(9,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory)
            {
            ...
            Span2D<int> span2d = array.AsSpan2D(3, 3).Slice(1, 0, 2, 3);
        ...
        [Test]
        public void Test_Span2DT_TryGetSpan_From1DNativeArray_3()
        {
            var array = new Unity.Collections.NativeArray<int>(9,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory)
            {
            ...
            Span2D<int> span2d = array.AsSpan2D(3, 3).Slice(0, 1, 3, 2);
        ...
        // See https://github.com/CommunityToolkit/WindowsCommunityToolkit/issues/3947
        [Test]
        public void Test_Span2DT_TryGetSpan_From1DNativeArray_4()
        {
            var array = new Unity.Collections.NativeArray<int>(128,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory);

            Span2D<int> span2d = array.AsSpan2D(8, 16);
        ...
        [Test]
        public unsafe void Test_Span2DT_NativeArray_GetRow()
        {
            var array = new Unity.Collections.NativeArray<int>(6,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory)
            {
            ...
            // Same as above, but with a Span2D<T> wrapping a raw pointer
            RefEnumerable<int> enumerable = array.AsSpan2D(2, 3, 0).GetRow(1);

            int[] expected = { 4, 5, 6 };

            CollectionAssert.AreEqual(enumerable.ToArray(), expected);

            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(2, 3, 0).GetRow(-1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(2, 3, 0).GetRow(2));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(2, 3, 0).GetRow(1000));
        }

        [Test]
        public unsafe void Test_Span2DT_NativeArray_GetColumn()
        {
            var array = new Unity.Collections.NativeArray<int>(6,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory)
            {
            ...
            // Same as above, but wrapping a raw pointer
            RefEnumerable<int> enumerable = array.AsSpan2D(2, 3, 0).GetColumn(2);

            int[] expected = { 3, 6 };

            CollectionAssert.AreEqual(enumerable.ToArray(), expected);

            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(2, 3, 0).GetColumn(-1));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(2, 3, 0).GetColumn(3));
            _ = Assert.Throws<ArgumentOutOfRangeException>(() => array.AsSpan2D(2, 3, 0).GetColumn(1000));
        }

        [Test]
        public unsafe void Test_Span2DT_NativeArray_GetEnumerator()
        {
            var array = new Unity.Collections.NativeArray<int>(6,
                Unity.Collections.Allocator.Temp, Unity.Collections.NativeArrayOptions.UninitializedMemory)
            {
            ...
            // Same test as above, but wrapping a raw pointer
            foreach (ref int item in array.AsSpan2D(1, 2, 2, 1))
            {
                // Check the reference again
                Assert.AreEqual(
                    array[((i / 2) * 3) + (i % 2) + 1],
