...
namespace PKGE.Tests
{
    public class MathematicsExtensionsTests
    {
        ...
        {
            Assert.AreEqual(2, Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<TCGE.Mathematics.Union2>());
            Assert.AreEqual(4, Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<TCGE.Mathematics.Union4>());
            Assert.AreEqual(8, Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<TCGE.Mathematics.Union8>());
            Assert.AreEqual(16, Unity.Collections.LowLevel.Unsafe.UnsafeUtility.SizeOf<TCGE.Mathematics.Union16>());
        }
