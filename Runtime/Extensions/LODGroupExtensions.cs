...
namespace PKGE.Packages
{
    ...
    {
        //https://github.com/needle-mirror/com.unity.entities.graphics/blob/94216e8b467b632bea0e41c2711c7aedf907bb57/Unity.Entities.Graphics/LODGroupExtensions.cs
        ...
        public struct LODParams : IEqualityComparer<LODParams>, System.IEquatable<LODParams>
        {
            ...
            /// <inheritdoc/>
            public readonly bool Equals(LODParams x, LODParams y)
            {
                return
            ...
            /// <inheritdoc/>
            public readonly bool Equals(LODParams x)
            {
                return
        ...
        public static LODParams CalculateLODParams(LODParameters parameters, float overrideLODBias = 0.0f)
        {
            ...
            else
            {
                ...
                // This is useful if the FOV is continuously changing (breaking LOD temporal cache) or you want to explicit control LOD bias.
        ...
        static int CalculateCurrentLODIndex(float4 lodDistances, float measuredDistanceSqr)
        {
            ...
            if (lodResult.x)
                ...
                return -1;
#else
            var lodResult = float4.Scale(lodDistances, lodDistances);

            if (measuredDistanceSqr < lodResult.x)
                return 0;
            else if (measuredDistanceSqr < lodResult.y)
                return 1;
            else if (measuredDistanceSqr < lodResult.z)
                return 2;
            else if (measuredDistanceSqr < lodResult.w)
                return 3;
            else
                // Can return 0 or 16. Doesn't matter...
                return -1;
...
#endif // INCLUDE_ENTITIES_GRAPHICS
