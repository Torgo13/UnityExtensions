...
namespace PKGE.Unsafe
{
    ...
    public static class DelegateHashCodeUtils
    {
        ...
        public static int GetFuncHashCode(Delegate del)
        {
            ...
            if (!MethodHashCodeToSkipTargetHashMap.TryGetValue(methodHashCode, out var skipTarget))
            {
                ...
                MethodHashCodeToSkipTargetHashMap.Add(methodHashCode, skipTarget);
            }
        ...
        //used for testing
#if UNITY_COLLECTIONS_2_1_4_OR_NEWER
        internal static int GetTotalCacheCount() => MethodHashCodeToSkipTargetHashMap.Count;
#else
        internal static int GetTotalCacheCount() => MethodHashCodeToSkipTargetHashMap.Count();
#endif // UNITY_COLLECTIONS_2_1_4_OR_NEWER

        internal static void ClearCache() => MethodHashCodeToSkipTargetHashMap.Clear();
        #endregion // UnityEngine.Rendering
    }
}
