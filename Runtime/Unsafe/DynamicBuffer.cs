...
namespace PKGE.Unsafe
{
    ...
    public unsafe struct DynamicBuffer<T> : IEnumerable<T>, INativeList<T> where T : unmanaged
    {
        //https://github.com/needle-mirror/com.unity.entities/blob/7866660bdd3140414ffb634a962b4bad37887261/Unity.Entities/Iterators/DynamicBuffer.cs
        ...
        internal DynamicBuffer(BufferHeader* header, AtomicSafetyHandle safety, AtomicSafetyHandle arrayInvalidationSafety, bool isReadOnly, bool useMemoryInitPattern, byte memoryInitPattern, int internalCapacity)
        {
            ...
            InitNativeContainer(m_Safety0);
            InitNativeContainer(m_Safety1);
        }
