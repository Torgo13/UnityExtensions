...
namespace PKGE
{
    ...
    public static class GeometryUtils
    {
        ...
        public static bool FindClosestEdge(ReadOnlySpan<Vector3> vertices, Vector3 point,
        ...
        public static Vector3 PointOnOppositeSideOfPolygon(ReadOnlySpan<Vector3> vertices, Vector3 point)
        {
        ...
        public static void ClosestPolygonApproach(ReadOnlySpan<Vector3> verticesA, ReadOnlySpan<Vector3> verticesB,
        ...
        public static bool PointInPolygon(Vector3 testPoint, ReadOnlySpan<Vector3> vertices)
        {
        ...
        public static bool PointInPolygon3D(Vector3 testPoint, ReadOnlySpan<Vector3> vertices)
        {
        ...
        public static bool ConvexHull2D(ReadOnlySpan<Vector3> points, List<Vector3> hull)
        {
        ...
        public static bool ConvexHull2D(ReadOnlySpan<Vector3> points, NativeList<Vector3> hull)
#else
        public static bool ConvexHull2D(ReadOnlySpan<Vector3> points, List<Vector3> hull)
        ...
        public static Vector3 PolygonCentroid2D(ReadOnlySpan<Vector3> vertices)
        {
            var vertexCount = vertices.Length;
        ...
        public static Vector2 OrientedMinimumBoundingBox2D(ReadOnlySpan<Vector3> convexHull, Span<Vector3> boundingBox)
        {
        ...
        static void RotateCalipers(Vector3 alignEdge, ReadOnlySpan<Vector3> vertices,
        ...
        public static Quaternion RotationForBox(ReadOnlySpan<Vector3> vertices)
        {
        ...
        public static float ConvexPolygonArea(ReadOnlySpan<Vector3> vertices)
        {
        ...
        public static bool PolygonInPolygon(ReadOnlySpan<Vector3> polygonA, ReadOnlySpan<Vector3> polygonB)
        {
        ...
        /// <returns>True if the polygons are within the specified distance from each other, false otherwise.</returns>
        public static bool PolygonsWithinSqRange(ReadOnlySpan<Vector3> polygonA, ReadOnlySpan<Vector3> polygonB, float maxSqDistance)
        {
        ...
        public static bool PointOnPolygonBoundsXZ(Vector3 testPoint, ReadOnlySpan<Vector3> vertices, float epsilon = float.Epsilon)
        {
