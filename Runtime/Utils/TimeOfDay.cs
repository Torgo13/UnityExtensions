...
namespace UnityExtensions
{
    ...
    public class TimeOfDay : MonoBehaviour
    {
        ...
        internal static void Window_StatusPanel(int windowID)
        {
            ...
            UnityEngine.GUI.Label(new Rect(Screen.width * 0.0f, 0, Screen.width * 0.1f, 30), "Midnight", textStyle);
            UnityEngine.GUI.Label(new Rect(Screen.width * 0.39f, 0, Screen.width * 0.02f, 30), "Noon", textStyle);
            float timeOfDay = UnityEngine.GUI.HorizontalSlider(new Rect(Screen.width * 0.015f, 25, Screen.width * 0.77f, 8), instance.timeOfDay, 0.0F, 24.0F, instance.sliderStyle, UnityEngine.GUI.skin.horizontalSliderThumb);
            UnityEngine.GUI.Label(new Rect(Screen.width * 0.7625f, 0, Screen.width * 0.1f, 30), "Midnight", textStyle);
