...
namespace UnityExtensions.Packages
{
    ...
    {
        //https://github.com/needle-mirror/com.unity.kinematica/blob/d5ae562615dab42e9e395479d5e3b4031f7dccaf/Editor/MotionLibraryBuilder/AnimationSampler/TransformSampler.cs
        ...
        public readonly FloatSampler GetCurveProxy(int curveIndex)
        {
            switch (curveIndex)
            {
