...
namespace UnityExtensions
{
    ...
    public static class ReflectionUtils
    {
        ...
        public static object InvokeStatic(this Type targetType, string methodName, params object[] args)
        {
            ...
            Assert.IsFalse(string.IsNullOrEmpty(methodName), "The methodName to set could not be null");
        ...
        {
            Assert.IsTrue(target != null, "The target could not be null");
            Assert.IsFalse(string.IsNullOrEmpty(methodName), "The method name to set could not be null");
        ...
        {
            Assert.IsTrue(target != null, "The target could not be null");
            Assert.IsFalse(string.IsNullOrEmpty(fieldName), "The field to set could not be null");
